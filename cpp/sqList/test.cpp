	...
	do {
		...
		switch (select)
		{
			...
			case 6:
				...
				scanf("%d", &order);
				det = L.GetElem(order, &e);
				print(det);
				if (1 == det)
				{
					printf("The value of order %d is : %c\n", order, e);
				}
				break;
			case 7:
				if (!L.ListExist())
